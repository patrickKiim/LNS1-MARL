...
//            ("paths,p", po::value<string>()->default_value("/home/marmot/Yutong/MAPF/training/cl_step_block_individual_ifbetter/record_files/paths0.txt"), "input file for paths")
//            ("outputPaths,o", po::value<string>()->default_value("/home/marmot/Yutong/MAPF/training/cl_step_block_individual_ifbetter/record_files/f2_output.txt"), "output file for statistics")
//            ("number,n", po::value<int>()->default_value(8), "number of agents")
//            ("ALNS,l", po::value<bool>()->default_value(true), "if use adaptive selection")
//            ("collisions,c", po::value<int>()->default_value(10), "number of collisions")
...
//            ("numberagents,g", po::value<int>()->default_value(300), "id of the selection method");
