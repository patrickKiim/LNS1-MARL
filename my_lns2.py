...
def readResults_2(resultFile):
    ...
    return global_num_collison, destroy_weights, local_agents, global_succ, selected_neighbor, makespan
...
def adaptive_destroy(temp_path,local_num_agents,ALNS,global_num_collison,
    ...
    global_num_collison, destroy_weights, local_agents, global_succ, selected_neighbor, makespan = readResults_2(resultFile)
